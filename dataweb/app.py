...
from dataweb.blueprints.admin import admin
from dataweb.blueprints.page import page
from dataweb.blueprints.contact import contact
from dataweb.blueprints.user import user

from dataweb.blueprints.user.models import User

from dataweb.extensions import (
    debug_toolbar,
    mail,
    csrf,
    db,
...
'''
from dataweb.blueprints.billing import billing
from dataweb.blueprints.billing import stripe_webhook
from dataweb.blueprints.bet import bet

from dataweb.blueprints.billing.template_processors import (
  format_currency,
  current_year
)
'''
...
CELERY_TASK_LIST = [
    'dataweb.blueprints.contact.tasks',
    'dataweb.blueprints.user.tasks',
]# 'dataweb.blueprints.billing.tasks',
